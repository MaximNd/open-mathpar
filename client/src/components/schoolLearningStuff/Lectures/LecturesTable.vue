  ...
  <v-card>
    ...
    >
      <template slot="items" slot-scope="props">
        <td @click="lec = true" class="text-xs-left clickable">{{ props.item.lectionName}}</td>
    ...
    <v-dialog v-model="lec" width="1500px">
      <v-card>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="green darken-1" flat="flat" @click="lec = false">Disagree</v-btn>
          <v-btn color="green darken-1" flat="flat" @click="lec = false">Agree</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </v-card>
